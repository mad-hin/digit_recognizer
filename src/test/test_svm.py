...
def predict_digit(img):
    with gzip.open("../svm_model/svm_model.gz", 'rb') as file:
...
ax.set_title("Confusion Matrix of the Linear SVM model (User Handwriting)")
plt.show()
...
"""
    ...
    accuracy                           0.44       100
   macro avg       0.44      0.41      0.38       100
weighted avg       0.78      0.44      0.50       100
"""